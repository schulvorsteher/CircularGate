...
namespace csse {
	...
	class CPulseButtonFactory : ViewCreatorAdapter
	{
	public:
		...
		{
			CRect size(CPoint(0, 0), CPoint(40,23));
            auto* button = new CPulseButton(size, nullptr, 0, nullptr);
	...
	CPulseButtonFactory __gCPulseButtonFactory;
